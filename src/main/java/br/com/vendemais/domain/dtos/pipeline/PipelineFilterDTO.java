 ...
 */
@Schema(name = "PipelineFilterDTO", description = "Parâmetros opcionais para filtragem da listagem de pipelines.")
public record PipelineFilterDTO(
        @Size(max = 120, message = "O termo de busca deve ter no máximo 120 caracteres")
        @Schema(
                description = "Termo usado para buscar pipelines pelo título.",
